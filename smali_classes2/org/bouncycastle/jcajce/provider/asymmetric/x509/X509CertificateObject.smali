...
# direct methods
.method public constructor <init>(Lorg/bouncycastle/jcajce/util/b;Lp3/h;)V
    .locals 7

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createBasicConstraints(Lp3/h;)Lp3/g;

    move-result-object v3

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createKeyUsage(Lp3/h;)[Z

    move-result-object v4

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createSigAlgName(Lp3/h;)Ljava/lang/String;

    move-result-object v5

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createSigAlgParams(Lp3/h;)[B
    ...
    invoke-direct/range {v0 .. v6}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;-><init>(Lorg/bouncycastle/jcajce/util/b;Lp3/h;Lp3/g;[ZLjava/lang/String;[B)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->attrCarrier:LC3/b;

    return-void
.end method

.method private static createBasicConstraints(Lp3/h;)Lp3/g;
    .locals 3
    ...
    invoke-static {p0}, Lp3/g;->n(LU2/t;)Lp3/g;
...
.method private static createKeyUsage(Lp3/h;)[Z
    .locals 7
...
.method private static createSigAlgName(Lp3/h;)Ljava/lang/String;
    .locals 3

    :try_start_0
    iget-object p0, p0, Lp3/h;->e:Lp3/a;

    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/d;->b(Lp3/a;)Ljava/lang/String;
...
.method private static createSigAlgParams(Lp3/h;)[B
    .locals 3
...
.method private getInternalCertificate()Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateInternal;
    ...
    iget-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->bcHelper:Lorg/bouncycastle/jcajce/util/b;

    iget-object v5, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->c:Lp3/h;

    iget-object v6, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->basicConstraints:Lp3/g;
    ...
    invoke-direct/range {v3 .. v11}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateInternal;-><init>(Lorg/bouncycastle/jcajce/util/b;Lp3/h;Lp3/g;[ZLjava/lang/String;[B[BLjava/security/cert/CertificateEncodingException;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, v0, Lp3/h;->k:LU2/c;

    if-eqz v0, :cond_3

    iget-object v2, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->c:Lp3/h;

    iget-object v2, v2, Lp3/h;->k:LU2/c;
...
.method public getBagAttribute(LU2/q;)LU2/g;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->attrCarrier:LC3/b;
