...
.method public constructor <init>([Lorg/bouncycastle/util/test/c;)V
    .locals 9
    ...
    instance-of v5, v1, Lorg/bouncycastle/util/test/a;

    if-eqz v5, :cond_1

    iget-object v1, v1, Lorg/bouncycastle/util/test/c;->a:[B
    ...
    instance-of v6, v5, Lorg/bouncycastle/util/test/a;

    if-eqz v6, :cond_7

    iget-object v5, v5, Lorg/bouncycastle/util/test/c;->a:[B
...
.method public constructor <init>([[B)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/util/test/FixedSecureRandom;->buildDataArray([[B)[Lorg/bouncycastle/util/test/b;
...
.method private static buildDataArray([[B)[Lorg/bouncycastle/util/test/b;
    .locals 4

    array-length v0, p0

    new-array v0, v0, [Lorg/bouncycastle/util/test/b;
    ...
    new-instance v2, Lorg/bouncycastle/util/test/b;

    aget-object v3, p0, v1

    invoke-direct {v2, v3}, Lorg/bouncycastle/util/test/c;-><init>([B)V
...
.method private static expandToBitLength(I[B)[B
    ...
    invoke-static {v1, p0, v2}, Lorg/bouncycastle/util/d;->o([BII)V
    ...
    invoke-static {v2, p1}, Lorg/bouncycastle/util/d;->b(I[B)I
    ...
    invoke-static {p1, p0, v2}, Lorg/bouncycastle/util/d;->o([BII)V
