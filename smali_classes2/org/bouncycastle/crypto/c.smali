.class public abstract Lorg/bouncycastle/crypto/c;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/crypto/c;->a:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/c;->b:Ljava/util/Map;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lorg/bouncycastle/crypto/c;->c:Ljava/lang/Object;
    ...
    invoke-static {v6}, Li4/c;->c(Ljava/lang/String;)[B

    move-result-object v6

    const/16 v7, 0x7b

    invoke-direct {v5, v6, v7}, Lv3/k;-><init>([BI)V

    invoke-direct {v0, v1, v2, v4, v5}, Lv3/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lv3/k;)V
    ...
    invoke-static {v7}, Li4/c;->c(Ljava/lang/String;)[B

    move-result-object v7

    const/16 v8, 0x107

    invoke-direct {v6, v7, v8}, Lv3/k;-><init>([BI)V

    invoke-direct {v1, v2, v4, v5, v6}, Lv3/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lv3/k;)V
    ...
    new-instance v7, Lv3/k;

    const-string v8, "8d5155894229d5e689ee01e6018a237e2cae64cd"

    invoke-static {v8}, Li4/c;->c(Ljava/lang/String;)[B

    move-result-object v8

    const/16 v9, 0x5c

    invoke-direct {v7, v8, v9}, Lv3/k;-><init>([BI)V

    invoke-direct {v2, v4, v5, v6, v7}, Lv3/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lv3/k;)V
    ...
    invoke-direct {v3, v8, v9}, Lv3/k;-><init>([BI)V

    invoke-direct {v4, v5, v6, v7, v3}, Lv3/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lv3/k;)V

    filled-new-array {v0, v1, v2, v4}, [Lv3/h;
    ...
    const-string v7, "Bad property value passed"

    if-eqz v6, :cond_3

    sget-object v6, Lorg/bouncycastle/crypto/c;->a:Ljava/lang/ThreadLocal;
    ...
    :cond_0
    const-string v6, "dsaDefaultParams"

    invoke-interface {v8, v6, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v8, Lorg/bouncycastle/crypto/c;->b:Ljava/util/Map;

    invoke-interface {v8, v6, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {v0}, Lorg/bouncycastle/crypto/c;->b(Lv3/h;)Lv3/c;

    move-result-object v0

    invoke-static {v1}, Lorg/bouncycastle/crypto/c;->b(Lv3/h;)Lv3/c;

    move-result-object v1

    invoke-static {v2}, Lorg/bouncycastle/crypto/c;->b(Lv3/h;)Lv3/c;

    move-result-object v2

    invoke-static {v4}, Lorg/bouncycastle/crypto/c;->b(Lv3/h;)Lv3/c;

    move-result-object v3

    filled-new-array {v0, v1, v2, v3}, [Lv3/c;
    ...
    sget-object v1, Lorg/bouncycastle/crypto/c;->a:Ljava/lang/ThreadLocal;
    ...
    sget-object v2, Lorg/bouncycastle/crypto/c;->b:Ljava/util/Map;
...
.method public static a()Ljava/security/SecureRandom;
    ...
    sget-object v0, Lorg/bouncycastle/crypto/c;->c:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lorg/bouncycastle/crypto/c;->d:Ljava/security/SecureRandom;
    ...
    :try_start_1
    sget-object v2, Lorg/bouncycastle/crypto/c;->d:Ljava/security/SecureRandom;

    if-nez v2, :cond_1

    sput-object v1, Lorg/bouncycastle/crypto/c;->d:Ljava/security/SecureRandom;
...
.method public static b(Lv3/h;)Lv3/c;
    .locals 9
    ...
    iget-object v1, p0, Lv3/h;->k:Lv3/k;

    iget-object v2, v1, Lv3/k;->a:[B

    invoke-static {v2}, Lorg/bouncycastle/util/d;->c([B)[B

    move-result-object v2

    iget v1, v1, Lv3/k;->b:I

    invoke-direct {v8, v2, v1}, Lv3/f;-><init>([BI)V

    iget-object v2, p0, Lv3/h;->e:Ljava/math/BigInteger;

    iget-object v3, p0, Lv3/h;->c:Ljava/math/BigInteger;

    iget-object v4, p0, Lv3/h;->d:Ljava/math/BigInteger;
