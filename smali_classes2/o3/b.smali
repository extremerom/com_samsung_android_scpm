...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v0

    const-string v1, "2.5.4.6"

    invoke-static {v1}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v1

    const-string v2, "2.5.4.3"

    invoke-static {v2}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v2

    const-string v3, "0.9.2342.19200300.100.1.25"

    invoke-static {v3}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v3

    const-string v4, "2.5.4.13"

    invoke-static {v4}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v4

    const-string v5, "2.5.4.27"

    invoke-static {v5}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v5

    const-string v6, "2.5.4.49"

    invoke-static {v6}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v6

    const-string v7, "2.5.4.46"

    invoke-static {v7}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v7

    const-string v8, "2.5.4.47"

    invoke-static {v8}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v8

    const-string v9, "2.5.4.23"

    invoke-static {v9}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v9

    const-string v10, "2.5.4.44"

    invoke-static {v10}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v10

    const-string v11, "2.5.4.42"

    invoke-static {v11}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v11

    const-string v12, "2.5.4.51"

    invoke-static {v12}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v12

    const-string v13, "2.5.4.43"

    invoke-static {v13}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v13

    const-string v14, "2.5.4.25"

    invoke-static {v14}, Lh/a;->b(Ljava/lang/String;)LU2/q;

    move-result-object v14

    const-string v15, "2.5.4.7"

    invoke-static {v15}, Lh/a;->b(Ljava/lang/String;)LU2/q;
    ...
    invoke-static/range {v16 .. v16}, Lh/a;->b(Ljava/lang/String;)LU2/q;
    ...
    sput-object v15, Lo3/b;->f:Ljava/util/Hashtable;
    ...
    sput-object v14, Lo3/b;->g:Ljava/util/Hashtable;
...
.method public constructor <init>()V
    ...
    sget-object v0, Lo3/b;->f:Ljava/util/Hashtable;

    invoke-static {v0}, Lp0/b;->g(Ljava/util/Hashtable;)Ljava/util/Hashtable;

    move-result-object v0

    iput-object v0, p0, Lo3/b;->e:Ljava/util/Hashtable;

    sget-object p0, Lo3/b;->g:Ljava/util/Hashtable;

    invoke-static {p0}, Lp0/b;->g(Ljava/util/Hashtable;)Ljava/util/Hashtable;
...
# virtual methods
.method public final V(Ln3/c;)Ljava/lang/String;
    .locals 5
    ...
    iget-object v4, p0, Lo3/b;->e:Ljava/util/Hashtable;

    invoke-static {v0, v3, v4}, Lr1/c;->l(Ljava/lang/StringBuffer;Ln3/b;Ljava/util/Hashtable;)V
