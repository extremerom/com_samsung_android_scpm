...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v6, v7}, Lm0/a;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    invoke-static {v1, v3}, Lcom/google/android/material/internal/u;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v1, v0, v4}, Ld0/d;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1, v0, v4}, Ld0/d;->c(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v8, p2, v6, v7}, Lg0/k;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Lg0/j;
    ...
    invoke-direct {v1, p0, p2}, LS/b;-><init>(Lcom/google/android/material/button/MaterialButton;Lg0/k;)V

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->a:LS/b;
    ...
    iget-object v5, v1, LS/b;->b:Lg0/k;

    int-to-float p2, p2

    invoke-virtual {v5}, Lg0/k;->e()Lg0/j;

    move-result-object v5

    new-instance v6, Lg0/a;

    invoke-direct {v6, p2}, Lg0/a;-><init>(F)V

    iput-object v6, v5, Lg0/j;->e:Lg0/c;

    new-instance v6, Lg0/a;

    invoke-direct {v6, p2}, Lg0/a;-><init>(F)V

    iput-object v6, v5, Lg0/j;->f:Lg0/c;

    new-instance v6, Lg0/a;

    invoke-direct {v6, p2}, Lg0/a;-><init>(F)V

    iput-object v6, v5, Lg0/j;->g:Lg0/c;

    new-instance v6, Lg0/a;

    invoke-direct {v6, p2}, Lg0/a;-><init>(F)V

    iput-object v6, v5, Lg0/j;->h:Lg0/c;

    invoke-virtual {v5}, Lg0/j;->a()Lg0/k;

    move-result-object p2

    invoke-virtual {v1, p2}, LS/b;->c(Lg0/k;)V

    iput-boolean v4, v1, LS/b;->p:Z
    ...
    invoke-static {p2, v3}, Lcom/google/android/material/internal/u;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    iput-object p2, v1, LS/b;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p2, v0, v2}, Ld0/d;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, v1, LS/b;->j:Landroid/content/res/ColorStateList;
    ...
    iput-object p2, v1, LS/b;->k:Landroid/content/res/ColorStateList;
    ...
    iput-object p2, v1, LS/b;->l:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v4, v1, LS/b;->o:Z

    iget-object v6, v1, LS/b;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v6, v1, LS/b;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final a()Z
    ...
    iget-object p0, p0, Lcom/google/android/material/button/MaterialButton;->a:LS/b;

    if-eqz p0, :cond_0

    iget-boolean p0, p0, LS/b;->q:Z
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, LS/b;->l:Landroid/content/res/ColorStateList;
...
.method public getShapeAppearanceModel()Lg0/k;
    ...
    iget-object p0, p0, LS/b;->b:Lg0/k;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, LS/b;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, LS/b;->j:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p0, p0, LS/b;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final onAttachedToWindow()V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->a:LS/b;

    invoke-virtual {v1, v0}, LS/b;->b(Z)Lg0/g;
...
.method public final performClick()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->a:LS/b;

    iget-boolean v0, v0, LS/b;->r:Z
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {p0, p1}, Lg0/g;->setTint(I)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v0, v1, LS/b;->o:Z

    iget-object v0, v1, LS/b;->j:Landroid/content/res/ColorStateList;

    iget-object v2, v1, LS/b;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    iget-object v0, v1, LS/b;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public setCornerRadius(I)V
    ...
    iget-object v0, p0, LS/b;->b:Lg0/k;
    ...
    invoke-virtual {p0, p1}, LS/b;->c(Lg0/k;)V
...
.method public setInsetBottom(I)V
    ...
    invoke-virtual {p0, v0, p1}, LS/b;->d(II)V
...
.method public setInsetTop(I)V
    ...
    invoke-virtual {p0, p1, v0}, LS/b;->d(II)V
...
.method public setOnPressedChangeListenerInternal(LS/a;)V
    .locals 0
    .param p1    # LS/a;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    iput-object p1, p0, Lcom/google/android/material/button/MaterialButton;->c:LS/a;
...
.method public setPressed(Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->c:LS/a;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, LS/b;->l:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, LS/b;->l:Landroid/content/res/ColorStateList;
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, LS/b;->k:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, LS/b;->k:Landroid/content/res/ColorStateList;
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, LS/b;->j:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, LS/b;->j:Landroid/content/res/ColorStateList;

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, LS/b;->b(Z)Lg0/g;
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v0, p0, LS/b;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, LS/b;->i:Landroid/graphics/PorterDuff$Mode;
