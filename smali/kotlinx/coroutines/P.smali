...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/coroutines/P;->q:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lkotlinx/coroutines/P;->w:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
...
.method public final C()J
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/Q;->D()Z
    ...
    :try_start_0
    iget-object v7, v0, Lkotlinx/coroutines/internal/x;->a:[Lkotlinx/coroutines/N;
    ...
    :cond_4
    :try_start_1
    iget-wide v8, v7, Lkotlinx/coroutines/N;->c:J
    ...
    invoke-virtual {p0, v7}, Lkotlinx/coroutines/P;->G(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {v0, v4}, Lkotlinx/coroutines/internal/x;->b(I)Lkotlinx/coroutines/N;
    ...
    :cond_7
    :goto_5
    sget-object v0, Lkotlinx/coroutines/P;->q:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sget-object v8, Lkotlinx/coroutines/internal/l;->g:Lcom/google/gson/internal/c;
    ...
    :cond_c
    sget-object v6, Lkotlinx/coroutines/z;->c:Lcom/google/gson/internal/c;
    ...
    sget-object v7, Lkotlinx/coroutines/internal/l;->f:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    :cond_13
    sget-object p0, Lkotlinx/coroutines/z;->c:Lcom/google/gson/internal/c;
    ...
    :try_start_2
    iget-object v0, p0, Lkotlinx/coroutines/internal/x;->a:[Lkotlinx/coroutines/N;
    ...
    :cond_17
    iget-wide v3, v3, Lkotlinx/coroutines/N;->c:J
    ...
    invoke-static {v3, v4, v1, v2}, Li1/b;->b(JJ)J
...
.method public F(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/P;->G(Ljava/lang/Runnable;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lkotlinx/coroutines/Q;->z()Ljava/lang/Thread;
    ...
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/A;->F(Ljava/lang/Runnable;)V
...
.method public final G(Ljava/lang/Runnable;)Z
    ...
    sget-object v2, Lkotlinx/coroutines/P;->w:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    :cond_a
    sget-object v2, Lkotlinx/coroutines/z;->c:Lcom/google/gson/internal/c;
...
.method public final H()Z
    ...
    :cond_5
    sget-object v0, Lkotlinx/coroutines/z;->c:Lcom/google/gson/internal/c;
...
.method public final I(JLkotlinx/coroutines/N;)V
    .locals 6

    sget-object v0, Lkotlinx/coroutines/P;->w:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    iput-wide p1, v5, Lkotlinx/coroutines/O;->c:J
    ...
    :cond_4
    invoke-virtual {p3, p1, p2, v0, p0}, Lkotlinx/coroutines/N;->a(JLkotlinx/coroutines/O;Lkotlinx/coroutines/P;)I
    ...
    :cond_6
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/Q;->E(JLkotlinx/coroutines/N;)V
    ...
    :try_start_0
    iget-object p2, p1, Lkotlinx/coroutines/internal/x;->a:[Lkotlinx/coroutines/N;
...
.method public final dispatch(Lkotlin/coroutines/i;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p2}, Lkotlinx/coroutines/P;->F(Ljava/lang/Runnable;)V

    return-void
.end method

.method public g(JLjava/lang/Runnable;Lkotlin/coroutines/i;)Lkotlinx/coroutines/I;
    .locals 0
...
.method public final p(JLkotlinx/coroutines/h;)V
    ...
    invoke-static {p1, p2}, Lkotlinx/coroutines/z;->g(J)J
    ...
    invoke-direct {v2, p0, p1, p2, p3}, Lkotlinx/coroutines/L;-><init>(Lkotlinx/coroutines/P;JLkotlinx/coroutines/h;)V

    invoke-virtual {p0, v0, v1, v2}, Lkotlinx/coroutines/P;->I(JLkotlinx/coroutines/N;)V
...
.method public shutdown()V
    ...
    sget-object v4, Lkotlinx/coroutines/z;->c:Lcom/google/gson/internal/c;
    ...
    :cond_6
    :goto_1
    invoke-virtual {p0}, Lkotlinx/coroutines/P;->C()J
    ...
    :cond_8
    invoke-virtual {p0, v2, v3, v4}, Lkotlinx/coroutines/Q;->E(JLkotlinx/coroutines/N;)V
