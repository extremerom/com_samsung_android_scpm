...
.field final synthetic val$runExpedited:Lo0/a;


# direct methods
.method public constructor <init>(Landroidx/work/impl/WorkerWrapper;Lo0/a;)V
    .locals 0
    ...
    iput-object p2, p0, Landroidx/work/impl/WorkerWrapper$1;->val$runExpedited:Lo0/a;
...
.method public run()V
    ...
    :cond_0
    :try_start_0
    iget-object v1, p0, Landroidx/work/impl/WorkerWrapper$1;->val$runExpedited:Lo0/a;
    ...
    invoke-virtual {v0}, Landroidx/work/ListenableWorker;->startWork()Lo0/a;

    move-result-object v0

    invoke-virtual {v1, v0}, Landroidx/work/impl/utils/futures/SettableFuture;->setFuture(Lo0/a;)Z
    :try_end_0
