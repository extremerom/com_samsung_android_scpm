...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v3, v4}, Lkotlin/jvm/internal/n;->b(Ljava/lang/Class;)Lkotlin/reflect/d;
    ...
    invoke-virtual {v3, v6}, Lkotlin/jvm/internal/n;->b(Ljava/lang/Class;)Lkotlin/reflect/d;

    move-result-object v6

    sget-object v7, Ljava/lang/Float;->TYPE:Ljava/lang/Class;

    invoke-virtual {v3, v7}, Lkotlin/jvm/internal/n;->b(Ljava/lang/Class;)Lkotlin/reflect/d;

    move-result-object v7

    sget-object v8, Ljava/lang/Integer;->TYPE:Ljava/lang/Class;

    invoke-virtual {v3, v8}, Lkotlin/jvm/internal/n;->b(Ljava/lang/Class;)Lkotlin/reflect/d;

    move-result-object v8

    sget-object v9, Ljava/lang/Long;->TYPE:Ljava/lang/Class;

    invoke-virtual {v3, v9}, Lkotlin/jvm/internal/n;->b(Ljava/lang/Class;)Lkotlin/reflect/d;

    move-result-object v9

    sget-object v10, Ljava/lang/Short;->TYPE:Ljava/lang/Class;

    invoke-virtual {v3, v10}, Lkotlin/jvm/internal/n;->b(Ljava/lang/Class;)Lkotlin/reflect/d;

    move-result-object v3

    const/16 v10, 0x8

    new-array v10, v10, [Lkotlin/reflect/d;
    ...
    invoke-static {v10}, Lkotlin/collections/q;->u0([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v2

    sput-object v2, Lkotlin/reflect/jvm/internal/impl/descriptors/runtime/structure/c;->a:Ljava/util/List;
    ...
    invoke-static {v5}, LP2/c;->y(Lkotlin/reflect/d;)Ljava/lang/Class;

    move-result-object v6

    invoke-static {v5}, LP2/c;->z(Lkotlin/reflect/d;)Ljava/lang/Class;
    ...
    :cond_0
    invoke-static {v3}, Lkotlin/collections/B;->i0(Ljava/util/List;)Ljava/util/Map;

    move-result-object v2

    sput-object v2, Lkotlin/reflect/jvm/internal/impl/descriptors/runtime/structure/c;->b:Ljava/util/Map;

    sget-object v2, Lkotlin/reflect/jvm/internal/impl/descriptors/runtime/structure/c;->a:Ljava/util/List;
    ...
    sput-object v2, Lkotlin/reflect/jvm/internal/impl/descriptors/runtime/structure/c;->c:Ljava/util/Map;

    const-class v24, Ld2/k;

    const-class v25, Ld2/m;

    const-class v5, Ld2/a;

    const-class v6, Ld2/l;

    const-class v7, Ld2/p;

    const-class v8, Ld2/q;

    const-class v9, Ld2/r;

    const-class v10, Ld2/s;

    const-class v11, Ld2/t;

    const-class v12, Ld2/u;

    const-class v13, Ld2/v;

    const-class v14, Ld2/w;

    const-class v15, Ld2/b;

    const-class v16, Ld2/c;

    const-class v17, Ld2/d;

    const-class v18, Ld2/e;

    const-class v19, Ld2/f;

    const-class v20, Ld2/g;

    const-class v21, Ld2/h;

    const-class v22, Ld2/i;

    const-class v23, Ld2/j;

    const-class v26, Ld2/n;

    const-class v27, Ld2/o;
...
.method public static final b(Ljava/lang/Class;)Ljava/lang/String;
    ...
    invoke-static {p0, v2, v1}, Lkotlin/text/v;->P(Ljava/lang/String;CC)Ljava/lang/String;
...
.method public static final c(Ljava/lang/reflect/Type;)Ljava/util/List;
    ...
    invoke-static {p0}, Lkotlin/collections/o;->m0([Ljava/lang/Object;)Ljava/util/List;
