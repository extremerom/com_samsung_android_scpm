...
.method static constructor <clinit>()V
    ...
    const-class v19, Ld2/k;

    const-class v20, Ld2/m;
    ...
    const-class v3, Ld2/q;

    const-class v4, Ld2/r;

    const-class v5, Ld2/s;

    const-class v6, Ld2/t;

    const-class v7, Ld2/u;

    const-class v8, Ld2/v;

    const-class v9, Ld2/w;

    const-class v10, Ld2/b;

    const-class v11, Ld2/c;

    const-class v12, Ld2/d;

    const-class v13, Ld2/e;

    const-class v14, Ld2/f;

    const-class v15, Ld2/g;

    const-class v16, Ld2/h;

    const-class v17, Ld2/i;

    const-class v18, Ld2/j;

    const-class v21, Ld2/n;

    const-class v22, Ld2/o;
    ...
    sput-object v0, Lkotlin/jvm/internal/f;->d:Ljava/util/Map;
    ...
    invoke-static {v1, v3}, Lkotlin/text/o;->q0(Ljava/lang/String;C)Ljava/lang/String;
    ...
    :cond_2
    sget-object v0, Lkotlin/jvm/internal/f;->d:Ljava/util/Map;
    ...
    invoke-static {v2, v3}, Lkotlin/text/o;->q0(Ljava/lang/String;C)Ljava/lang/String;
    ...
    :cond_4
    sput-object v0, Lkotlin/jvm/internal/f;->k:Ljava/util/LinkedHashMap;
...
.method public constructor <init>(Ljava/lang/Class;)V
    ...
    iput-object p1, p0, Lkotlin/jvm/internal/f;->c:Ljava/lang/Class;
...
.method public final c()Ljava/lang/Class;
    ...
    iget-object p0, p0, Lkotlin/jvm/internal/f;->c:Ljava/lang/Class;
...
.method public final g()Ljava/lang/String;
    ...
    sget-object v2, Lkotlin/jvm/internal/f;->e:Ljava/util/HashMap;
...
.method public final h()Ljava/lang/String;
    ...
    sget-object v2, Lkotlin/jvm/internal/f;->k:Ljava/util/LinkedHashMap;
