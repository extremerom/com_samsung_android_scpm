...
.method public constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;Landroidx/appcompat/widget/TintTypedArray;)V
    ...
    iput-object p1, p0, Lk0/w;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    iput-object v1, p0, Lk0/w;->d:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iput-object v4, p0, Lk0/w;->b:Landroidx/appcompat/widget/AppCompatTextView;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v5

    invoke-static {v5}, Ld0/d;->d(Landroid/content/Context;)Z
    ...
    :cond_0
    iget-object v5, p0, Lk0/w;->i:Landroid/view/View$OnLongClickListener;

    const/4 v6, 0x0

    invoke-virtual {v1, v6}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-static {v1, v5}, LP2/k;->m0(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V

    iput-object v6, p0, Lk0/w;->i:Landroid/view/View$OnLongClickListener;

    invoke-virtual {v1, v6}, Landroid/view/View;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    invoke-static {v1, v6}, LP2/k;->m0(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V
    ...
    invoke-static {v7, p2, v5}, Ld0/d;->b(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v5

    iput-object v5, p0, Lk0/w;->e:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v5, v6}, Lcom/google/android/material/internal/u;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v5

    iput-object v5, p0, Lk0/w;->f:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p0, v5}, Lk0/w;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    iget v7, p0, Lk0/w;->g:I

    if-eq v5, v7, :cond_5

    iput v5, p0, Lk0/w;->g:I
    ...
    invoke-static {v3}, LP2/k;->M(I)Landroid/widget/ImageView$ScaleType;

    move-result-object v3

    iput-object v3, p0, Lk0/w;->h:Landroid/widget/ImageView$ScaleType;
    ...
    :goto_0
    iput-object v6, p0, Lk0/w;->c:Ljava/lang/CharSequence;
...
.method public final a()I
    ...
    iget-object v0, p0, Lk0/w;->d:Lcom/google/android/material/internal/CheckableImageButton;
...
.method public final b(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p0, Lk0/w;->e:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Lk0/w;->f:Landroid/graphics/PorterDuff$Mode;

    iget-object v2, p0, Lk0/w;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    iget-object p0, p0, Lk0/w;->e:Landroid/content/res/ColorStateList;
    ...
    iget-object p1, p0, Lk0/w;->i:Landroid/view/View$OnLongClickListener;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-static {v0, p1}, LP2/k;->m0(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V

    iput-object v1, p0, Lk0/w;->i:Landroid/view/View$OnLongClickListener;

    invoke-virtual {v0, v1}, Landroid/view/View;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    invoke-static {v0, v1}, LP2/k;->m0(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V
...
.method public final d()V
    ...
    iget-object v0, p0, Lk0/w;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    :cond_0
    iget-object v1, p0, Lk0/w;->d:Lcom/google/android/material/internal/CheckableImageButton;
...
.method public final e()V
    ...
    iget-object v0, p0, Lk0/w;->c:Ljava/lang/CharSequence;
    ...
    :goto_0
    iget-object v3, p0, Lk0/w;->d:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v1, p0, Lk0/w;->b:Landroidx/appcompat/widget/AppCompatTextView;

    invoke-virtual {v1, v0}, Landroid/view/View;->setVisibility(I)V

    iget-object p0, p0, Lk0/w;->a:Lcom/google/android/material/textfield/TextInputLayout;
